...
public class CommandButtonsModel
{
	...
	[Inject] private CommandCreatorBase<IHoldCommand> _stopper;
	[Inject] private CommandCreatorBase<IMoveCommand> _mover;
	[Inject] private CommandCreatorBase<IPatrolCommand> _patroller;
	[Inject] private CommandCreatorBase<IDeparturePoint> _departure;
	...
	public void OnCommandButtonClicked(ICommandExecutor commandExecutor)
	{
		...
		_departure.ProcessCommandExecutor(commandExecutor, command => ExecuteCommandWrapper(commandExecutor, command));
	}
