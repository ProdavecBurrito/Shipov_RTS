...
public class AutoAttackEvaluator : MonoBehaviour
{
    ...
    public class AttackerParallellnfo
    {
        public float VisionRadius;
        public ICommand CurrentCommand;

        public AttackerParallellnfo(float visionRadius, ICommand currentCommand)
        {
    ...
    public static ConcurrentDictionary<GameObject, AttackerParallellnfo> AttackersInfo = new ConcurrentDictionary<GameObject, AttackerParallellnfo>();
    ...
    private void evaluate(GameObject go, AttackerParallellnfo info)
    {
